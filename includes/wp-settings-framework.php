...
if ( ! class_exists( 'ubermediaWordPressSettingsFramework' ) ) {
	...
	class ubermediaWordPressSettingsFramework {
		...
		function admin_init() {
			register_setting(
				$this->option_group, $this->option_group . '_settings', array(
					&$this,
					'settings_validate'
				)
			);
				...
				foreach ( $wpsf_ubermedia_settings as $section ) {
					if ( isset( $section['section_id'] ) && $section['section_id'] && isset( $section['section_title'] ) ) {
						add_settings_section(
							$section['section_id'], $section['section_title'], array(
								&$this,
								'section_intro'
							), $this->option_group
						);
		...
		function settings() {
			...
			<form action="options.php" method="post">
				...
				<p class="submit">
					<input type="submit" class="button-primary" value="<?php _e( 'Save All Changes' ); ?>" /></p>
			</form>
			<?php
